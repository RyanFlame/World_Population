...
if selected2 == "Home":
        ...
        with left_column:
            annotated_text("The world population dataset contains comprehensive information on population counts for various nations from 1970 to 2050, as well as data on growth rates, fertility rates, and urbanisation levels. It provides a fascinating insight into worldwide demographic trends. The detailed data, including factors such as population ranking and net change, enables us to examine population trends not only at a national level but also across different continents. Envision identifying certain locations experiencing rapid growth in urban populations or regions with decreasing fertility rates. These findings can help politicians make smart decisions about how to distribute resources for infrastructure development, educational programmes, and healthcare efforts.")
